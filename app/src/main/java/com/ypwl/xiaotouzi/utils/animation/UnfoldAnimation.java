...
public class UnfoldAnimation extends Animation {
    ...
    /**
     * @param numOfFolds The number of folds to set.
    ...
    /**
     * The available orientations are <code>FoldLayout.Orientation.HORIZONTAL</code> and
     * <code>FoldLayout.Orientation.VERTICAL</code>.
     *
     ...
     * <code>FoldLayout.Orientation.VERTICAL</code>.
     *
     * @param orientation The orientation of the fold to set.
     * @return This object, allowing calls to methods in this class to be
     * chained.
     */
     ...
     * anchor the fold on the left, the anchor factor should be 0.
     *
     * @param anchorFactor The anchor factor of the fold to set.
     * @return This object, allowing calls to methods in this class to be
     * chained.
     */
