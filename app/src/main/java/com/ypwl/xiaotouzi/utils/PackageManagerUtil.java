...
public class PackageManagerUtil {
    ...
    /** 包名-QQ */
    public static final String PACKNAME_QQ = "com.tencent.mobileqq";
    /** 包名-微信 */
    public static final String PACKNAME_MM = "com.tencent.mm";
    /** 包名-新浪微博 */
    public static final String PACKNAME_SINA = "com.sina.weibo";
     ...
     *
     * @param mContext  上下文
     * @param TagClass  快捷方式启动目标
     * @param iconResId 快捷方式的图标
     * @param iconName  快捷方式的标题
     */
    public static void addShortCut2Desktop(Context mContext, Class<?> TagClass, int iconResId, String iconName) {
        SharedPreferences sp = mContext.getSharedPreferences(Const.SP_FILENAME_XTZ, Context.MODE_PRIVATE);
        ...
        if (appProcesses != null) {
            for (RunningAppProcessInfo appProcess : appProcesses) {
                if (myPid == appProcess.pid) {
                    LogUtil.d(TAG, "process.pid appProcess.processName=" + appProcess.processName + ", endProcessName="
                            + endProcessName);
