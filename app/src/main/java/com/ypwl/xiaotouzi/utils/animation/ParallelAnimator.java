...
public class ParallelAnimator extends Animation {
     ...
     *
     * @param combinable The Animation object that implements the {@link Combinable}
     ...
     *
     * @param interpolator The interpolator of the entire parallel animation to set.
     */
     ...
     * parallel animations.
     *
     * @param duration The duration of the entire parallel animation to set.
     */
    ...
    /**
     * @param listener The listener to set for the end of the parallel animation.
     */
