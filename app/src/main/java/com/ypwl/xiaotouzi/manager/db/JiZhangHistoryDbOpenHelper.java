 ...
 */
public class JiZhangHistoryDbOpenHelper extends SQLiteOpenHelper{
    private static final String TAG = "JiZhangHistoryDbOpenHelper";
    /** 数据库名 */
    public static final String DBName = "history_jizhang.db";
    /** 数据库版本 */
    public static final int DBVersion = 1;
    /** 收藏 表 */
    public static final String TABLE_HISTORY_INFO = "jizhang_history_info";
    ...
    public static final class HistoryDbHelper {
        ...
        /** 数据库操作 */
        protected JiZhangHistoryDbOpenHelper mDbOpenHelper = null;
        /** 数据库操作对象 */
        protected SQLiteDatabase mDatabase = null;

        public HistoryDbHelper(Context context) {
            this.mContext = context;
            mDbOpenHelper = new JiZhangHistoryDbOpenHelper(context, DBName, null, DBVersion);
        ...
        public List<PlatformChooseAdapterBean> queryAll() {
            ...
            try {
                ...
                while (cursor.moveToNext()){
                    ...
                    if(p_name.trim().length()==0){continue;}
    ...
    public JiZhangHistoryDbOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
