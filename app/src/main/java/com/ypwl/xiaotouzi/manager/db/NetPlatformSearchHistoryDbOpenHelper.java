 ...
 */
public class NetPlatformSearchHistoryDbOpenHelper extends SQLiteOpenHelper{
    private static final String TAG = "NetPlatformSearchHistoryDbOpenHelper";
    /** 数据库名 */
    public static final String DBName = "history_netplatform_search.db";
    /** 数据库版本 */
    public static final int DBVersion = 1;
    /** 收藏 表 */
    public static final String TABLE_HISTORY_INFO = "jizhang_netplatform_search_info";
    ...
    public static final class HistoryDbHelper {
        ...
        /** 数据库操作 */
        protected NetPlatformSearchHistoryDbOpenHelper mDbOpenHelper = null;
        /** 数据库操作对象 */
        protected SQLiteDatabase mDatabase = null;

        public HistoryDbHelper(Context context) {
            this.mContext = context;
            mDbOpenHelper = new NetPlatformSearchHistoryDbOpenHelper(context, DBName, null, DBVersion);
        ...
        /** 查询所有 */
        public List<SearchPlatformResultBean.DataEntity> queryAll() {
            List<SearchPlatformResultBean.DataEntity> result = new ArrayList<>();
            Cursor cursor = null;
            SQLiteDatabase database = getSQLiteDatabase();
            try {
                cursor = database.query(TABLE_HISTORY_INFO, null, null, null, null, null, null);
                while (cursor.moveToNext()){
                    SearchPlatformResultBean.DataEntity bean = new SearchPlatformResultBean.DataEntity();
        ...
        /** 根据pid修改历史记录数据 */
        public void updateByPid(String pid,String p_name,String date)
        {
    ...
    public NetPlatformSearchHistoryDbOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
