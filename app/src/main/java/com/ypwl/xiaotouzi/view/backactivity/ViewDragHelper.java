...
public class ViewDragHelper {
     ...
     * callback's and methods will only be invoked for edges for which edge tracking has been enabled.
     *
     ...
     * callback will be notified but will not be asked permission to capture this view.
     *
