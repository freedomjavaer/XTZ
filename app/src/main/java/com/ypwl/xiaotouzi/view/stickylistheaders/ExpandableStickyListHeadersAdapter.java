 ...
 class ExpandableStickyListHeadersAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(mCollapseHeaderIds.contains(getHeaderId(i))){
            convertView.setVisibility(mHideAll?View.VISIBLE:View.GONE);
        }else {
            convertView.setVisibility(mHideAll?View.GONE:View.VISIBLE);
        }
        return convertView;
    }
    ...
    public void beginHideAll(boolean hideAll){
