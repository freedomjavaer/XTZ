...
package com.ypwl.xiaotouzi.view.dialog.lib;
...
class AnnularView extends View implements Determinate {
    ...
    private void init(Context context) {
        ...
        mWhitePaint.setStrokeWidth(Helper.dpToPixel(3, context));
        mWhitePaint.setColor(Color.WHITE);

        mGreyPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mGreyPaint.setStyle(Paint.Style.STROKE);
        mGreyPaint.setStrokeWidth(Helper.dpToPixel(3, context));
        mGreyPaint.setColor(context.getResources().getColor(R.color.cd_hud_default_gray));
