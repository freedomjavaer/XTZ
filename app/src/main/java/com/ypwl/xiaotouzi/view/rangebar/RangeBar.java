...
package com.ypwl.xiaotouzi.view.rangebar;
...
public class RangeBar extends View {
    ...
    private static final float DEFAULT_BAR_WEIGHT_PX = 5;
    private static final int DEFAULT_BAR_COLOR = tranfColor("#CCCCCC");//两边的颜色
    private static final float DEFAULT_CONNECTING_LINE_WEIGHT_PX = 3;
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.mipmap.icon2_nor;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.mipmap.icon2_nor;

    // Corresponds to android.R.color.holo_blue_light.
    private static final int DEFAULT_CONNECTING_LINE_COLOR = 0xff3DB5E6;//中间的颜色
    ...
    /**
     * 转换成颜色int
     * @param color    #F3F4F5 或 F3F4F5
     * @return  #FFF3F4F5
     */
    public static int tranfColor(String color){
        String c;
        if(color.startsWith("#")){//#F3F4F5
            c =  "#FF"+color.substring(1);
        }else {//F3F4F5
            c =  "#FF"+color;
        }
