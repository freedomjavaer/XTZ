...
public class GesturePoint {
    ...
    public void setPointState(int state) {
        ...
        switch (state) {
            case POINT_STATE_NORMAL:
                this.image.setBackgroundResource(R.mipmap.gp_gesture_node_normal);
                break;
            case POINT_STATE_SELECTED:
                this.image.setBackgroundResource(R.mipmap.gp_gesture_node_pressed);
                break;
            case POINT_STATE_WRONG:
                this.image.setBackgroundResource(R.mipmap.gp_gesture_node_wrong);
                break;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (image == null) {
            ...
            return false;
        return leftX == other.leftX && rightX == other.rightX && topY == other.topY;
    }
