...
class AdapterWrapper extends BaseAdapter implements StickyListHeadersAdapter {
	...
	/**
	 * Will recycle header from {@link se.emilsjolander.stickylistheaders.WrapperView} if it exists
	 */
	 ...
	 * {@link se.emilsjolander.stickylistheaders.WrapperView} and will also recycle the divider if it exists.
	 */
