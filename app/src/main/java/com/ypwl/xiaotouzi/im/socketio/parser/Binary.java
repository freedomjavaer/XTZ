...
public class Binary {
    ...
    private static final String TAG = "ymseeage:" + Binary.class.getName();
    ...
    private static Object _deconstructPacket(Object data, List<byte[]> buffers) {
        ...
        if (data instanceof byte[]) {
            ...
            try {
                ...
                LogUtil.w(TAG, "An error occured while putting data to JSONObject", e);
                return null;
            }
            ...
            for (int i = 0; i < len; i++) {
                try {
                    ...
                    LogUtil.w(TAG, "An error occured while putting packet data to JSONObject", e);
                    return null;
                }
            }
            return newData;
