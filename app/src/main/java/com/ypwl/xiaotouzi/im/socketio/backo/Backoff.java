package com.ypwl.xiaotouzi.im.socketio.backo;
...
public class Backoff {
    ...
    public long duration() {
        ...
        if (jitter != 0.0) {
            ...
            BigInteger deviation = BigDecimal.valueOf(rand).multiply(BigDecimal.valueOf(jitter)).multiply(new BigDecimal(ms)).toBigInteger();
