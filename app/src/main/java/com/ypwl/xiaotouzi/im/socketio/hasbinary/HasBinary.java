package com.ypwl.xiaotouzi.im.socketio.hasbinary;
...
public class HasBinary {
    ...
    private static final String TAG = "ymseeage:" + HasBinary.class.getName();
        ...
        if (obj instanceof JSONArray) {
            ...
            while (keys.hasNext()) {
                ...
                try {
                    ...
                    LogUtil.e(TAG, "An error occured while retrieving data from JSONObject", e);
                    return false;
                }
                if (_hasBinary(v)) {
                    return true;
